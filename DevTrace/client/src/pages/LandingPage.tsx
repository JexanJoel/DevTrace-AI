  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs bg-indigo-50 text-indigo-600 border border-indigo-100 px-2 py-0.5 rounded-full font-medium">Open Source</span>
          </div>
          <div className="flex items-center gap-3">
            <a
              href="https://github.com/JexanJoel/DevTrace-AI"
              target="_blank"
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-indigo-200 opacity-20 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <button
              onClick={() => navigate('/register')}
              className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-3.5 rounded-xl transition text-base shadow-lg shadow-indigo-200"
            >
              Start debugging free <ArrowRight size={18} />
            </button>
            <button
              onClick={() => navigate('/login')}
              className="flex items-center gap-2 border-2 border-gray-200 hover:border-indigo-300 text-gray-700 font-semibold px-8 py-3.5 rounded-xl transition text-base"
            >
              Sign in
            </button>
          </div>
        ...
        <div className="relative max-w-3xl mx-auto mt-16">
          <div className="bg-gray-900 rounded-2xl shadow-2xl overflow-hidden border border-gray-800">
            <div className="flex items-center gap-2 px-5 py-3.5 border-b border-gray-800">
              ...
              <span className="ml-3 text-gray-500 text-xs font-mono">devtrace · session #42</span>
            </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((f, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-100 p-6 hover:border-indigo-200 hover:shadow-md transition group">
                <div className={`w-11 h-11 ${f.color} rounded-2xl flex items-center justify-center mb-4`}>
                  {f.icon}
                </div>
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">From error to fix in under 30 seconds</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {STEPS.map((s, i) => (
              <div key={i} className="relative text-center">
                {i < STEPS.length - 1 && (
                  <div className="hidden sm:block absolute top-8 left-[60%] w-[80%] h-px bg-indigo-100" />
                )}
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <button
                onClick={() => navigate('/register')}
                className="flex items-center gap-2 bg-white hover:bg-gray-50 text-indigo-600 font-bold px-8 py-3.5 rounded-xl transition text-base shadow-lg"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 border-2 border-white/30 hover:border-white/60 text-white font-semibold px-8 py-3.5 rounded-xl transition text-base"
              >
      ...
      <footer className="py-8 px-6 border-t border-gray-100">
        <div className="max-w-6xl mx-auto flex items-center justify-between flex-wrap gap-4">
          ...
          <p className="text-gray-400 text-sm">Built with React, Supabase, and Groq AI · 2026</p>
        </div>
      </footer>
