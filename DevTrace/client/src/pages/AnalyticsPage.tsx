// AnalyticsPage.tsx — error analytics with recharts
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="bg-white rounded-2xl border border-gray-100 p-5">
              <div className={`w-9 h-9 ${c.bg} rounded-xl flex items-center justify-center ${c.color} mb-3`}>
                {c.icon}
              </div>
        ...
        {sessions.length === 0 ? (
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              <h3 className="font-bold text-gray-900 mb-1">Sessions Over Time</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {/* Status pie */}
              <div className="bg-white rounded-2xl border border-gray-100 p-6">
                <h3 className="font-bold text-gray-900 mb-1">Status Breakdown</h3>
              ...
              {/* Severity bar */}
              <div className="bg-white rounded-2xl border border-gray-100 p-6">
                <h3 className="font-bold text-gray-900 mb-1">Severity Breakdown</h3>
            ...
            {topErrors.length > 0 && (
              <div className="bg-white rounded-2xl border border-gray-100 p-6">
                <h3 className="font-bold text-gray-900 mb-1">Top Error Patterns</h3>
                    ...
                    <div key={i} className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          <p className="text-sm font-mono text-gray-700 truncate">{e.pattern}</p>
