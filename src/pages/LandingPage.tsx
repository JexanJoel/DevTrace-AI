...
/* ─── Features ─────────────────────────────────────────────────── */
// 8 features: merged "AI Insights" into "Analytics & Insights", added "Similar Sessions"
const FEATURES = [
  {
  ...
  },
  {
    ...
    desc: 'Share projects and sessions with other DevTrace users for read-only collaboration. Instant access with no email required — revokable anytime directly from your dashboard.',
    color: 'purple',
    tag: null,
  },
  {
...
const STEPS = [
  ...
  { icon: <History size={20} />,     step: '03', title: 'See similar past bugs',   desc: 'DevTrace AI instantly queries your local SQLite for similar errors — zero network. If you\'ve seen this bug before, it surfaces immediately.' },
  ...
  { icon: <CheckCircle size={20} />, step: '05', title: 'Work through the fix',    desc: 'Use the 8-tab panel: chat with the AI about your specific bug, check off action items, paste logs for noise filtering, review your architecture.' },
  { icon: <Library size={20} />,     step: '06', title: 'Save to Fix Library',     desc: 'Save what worked. Your Fix Library grows over time — filter by language, copy fixes in one click, reuse across projects.' },
  { icon: <Users size={20} />,       step: '07', title: 'Share or export',         desc: 'Share the session with a teammate for read-only access, or export it as Markdown for your docs, PRs, or post-mortems.' },
  { icon: <Dna size={20} />,         step: '08', title: 'Generate your Debug DNA', desc: 'Hit "Generate My DNA" — a Supabase Edge Function queries your history server-side, Groq writes your personal debugging fingerprint. Export as Markdown.' },
];
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="py-14 sm:py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Feature grid — 4 cols on xl, 2 on sm, 1 on mobile */}
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      {f.tag && (
                        <span className={`text-[10px] font-bold px-2 py-1 rounded-lg flex-shrink-0 ${c.tag}`}>
                          {f.tag}
                        </span>
                      )}
                    </div>
                    ...
                    {/* Title */}
                    <h3 className="font-bold text-gray-900 mb-2 text-sm sm:text-base leading-snug">
                      {f.title}
                    </h3>
          ...
          <div className="mt-10 sm:mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              { value: '5',      label: 'synced tables',          color: 'text-green-600'  },
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <ul className="space-y-2.5 text-sm text-gray-500 flex-1">
                  {[
                    ...
                    'Edge Function for Debug DNA + AI',
                  ].map((item, i) => (
              ...
              <div className="p-5 sm:p-6 flex flex-col flex-1">
                ...
                <ul className="space-y-2.5 text-sm text-gray-500 flex-1">
                  {[
                    ...
                    'Offline write queue via mutations',
                    'Auto-sync on reconnect',
                    'Similar Sessions runs on SQLite',
