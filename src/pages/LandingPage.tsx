...
const FEATURES = [
  ...
  { icon: <WifiOff size={22} />,  title: 'Fully Offline-First',       desc: 'All data reads from local SQLite via PowerSync — zero spinners, zero network dependency. Create and browse sessions without internet. Auto-syncs when connection is restored.',   color: 'bg-orange-50 text-orange-500' },
  ...
  { icon: <Bug size={22} />,      title: 'Session Tracking',          desc: 'Log errors with stack traces, code snippets, expected behavior, environment, and severity. Every session is permanent, searchable, and never lost across projects or devices.',      color: 'bg-red-50 text-red-500'      },
  { icon: <BookOpen size={22} />, title: 'Fix Library',               desc: 'Save AI fixes that worked. Filter by language, copy in one click, track usage count. Build a personal knowledge base of solutions that grows smarter with every project.',          color: 'bg-green-50 text-green-500'  },
  { icon: <Share2 size={22} />,   title: 'Share with Teammates',      desc: 'Share projects and sessions with other DevTrace users for read-only collaboration. Instant access with no email required — revokable anytime directly from your dashboard.',         color: 'bg-purple-50 text-purple-500' },
  { icon: <BarChart2 size={22} />,title: 'Analytics & Insights',      desc: 'Project health scores, session streaks, resolution rates, AI confidence trends, and error patterns — all computed locally from your SQLite data with zero server round-trips.',     color: 'bg-blue-50 text-blue-500'    },
  { icon: <Zap size={22} />,      title: 'AI Insights',               desc: 'Get proactive suggestions surfaced from your debugging history — recurring error clusters, risky code patterns, and actionable tips generated by Groq to level up your workflow.',    color: 'bg-yellow-50 text-yellow-500' },
];
